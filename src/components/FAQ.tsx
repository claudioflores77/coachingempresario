...
const FAQ: React.FC = () => {
  ...
  const faqData: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "El Método P.U.D.E.R. no es teoría genérica, es un sistema específico diseñado por y para empresarios atrapados en su negocio. Las 5 diferencias clave son: (1) PERSONALIZACIÓN TOTAL: No hay dos empresas iguales, adaptamos TODO a tu realidad, (2) IMPLEMENTACIÓN PRÁCTICA: No solo consultamos, implementamos contigo paso a paso, (3) RESULTADOS MEDIBLES: Reducción de horas y aumento de rentabilidad verificables, (4) ACOMPAÑAMIENTO DIRECTO: Trabajas directamente conmigo, no con un equipo de juniors, (5) GARANTÍA DE RESULTADOS: Si sigues el método y no ves resultados en 90 días, trabajamos gratis hasta que los veas. 18 años de experiencia y 270+ casos de éxito nos respaldan.",
      category: 'method'
    },
    {
