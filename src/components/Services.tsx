...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, icon }) => {
  return (
    <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-all border-t-4 border-consulting-gold">
      <div className="mb-6 text-consulting-blue">
        {icon}
      </div>
...
const Services: React.FC = () => {
  return (
    <section id="servicios" className="section bg-consulting-gray-light">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Nuestros <span className="text-consulting-gold">Servicios</span>
          </h2>
        ...
        <div className="mt-16 bg-white p-8 md:p-12 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-consulting-blue text-white flex items-center justify-center mx-auto mb-4 text-xl font-bold">1</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-consulting-blue text-white flex items-center justify-center mx-auto mb-4 text-xl font-bold">2</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-consulting-blue text-white flex items-center justify-center mx-auto mb-4 text-xl font-bold">3</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-consulting-blue text-white flex items-center justify-center mx-auto mb-4 text-xl font-bold">4</div>
